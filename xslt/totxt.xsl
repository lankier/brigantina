...
<!-- styles -->
<xsl:template match="fb:strong|fb:emphasis|fb:style|fb:sub|fb:sup|fb:code|fb:strikethrough"><xsl:apply-templates/></xsl:template>
...
<!-- avoid recursion -->
<xsl:template match="fb:a" mode="note"><xsl:apply-templates/></xsl:template>
